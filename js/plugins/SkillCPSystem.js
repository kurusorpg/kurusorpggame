...
Imported['ySkillCPSystem'] = 1.02;

/*:
 * @plugindesc ver1.02/スキルを装備して使用するシステムを追加します。
 * @author Yana
 * 
...
(function(){
	...
	Game_Actor.prototype.isIncludeLearningSkills = function(skillId) {
		...
		return this.learningsSkills().contains(skillId);
	};
	...
	Game_Actor.prototype.refresh = function(){
		...
		if (this.maxSkillSetPoint() < this._settingSkills.length) {
			var num = this._settingSkills.lenght - this.maxSkillSetPoint();
