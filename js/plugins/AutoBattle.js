...
Imported['yAutoBattle'] = 1.02;

/*:
 * @plugindesc ver1.02/戦闘中にキー入力でオートバトルを開始できるようにします。また、オートバトル中は高速化します。
 * @author Yana
 *
...
(function(){
	...
	Scene_Battle.prototype.startPartyCommandSelection = function() {
		if (!(BattleManager.isAutoBattleInvalid() || this.isHideAutoBattleWindow())){
